  ...
  return (
    ...
    <div className="min-h-screen bg-page flex flex-col items-center px-6 md:px-20 py-16">
      ...
      <p className="text-paragraph text-center mb-12 max-w-2xl">
        Have questions or feedback about <span className="font-semibold text-primary">CVCraft</span>? Reach out using the form below or via our contact info. We’d love to hear from you!
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-4xl w-full">
        ...
        {/* Contact Form */}
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 bg-white p-6 rounded-xl shadow-3d-light">
          <input
            type="text"
            name="name"
            value={form.name}
