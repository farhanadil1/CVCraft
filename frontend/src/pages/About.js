  ...
  return (
    ...
    <div className="min-h-screen bg-page flex flex-col items-center px-6 md:px-20 py-16 text-gray-800">
      ...
      <p className="max-w-3xl text-paragraph text-lg md:text-xl text-center leading-relaxed mb-8">
        <span className="font-semibold text-primary">CVCraft</span> is a modern, minimal, and intuitive online CV/resume builder designed to help users create professional resumes effortlessly. Our goal is to make CV creation simple, aesthetic, and ATS-friendly for all job seekers.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full">
        ...
        <div className="bg-white p-6 rounded-xl shadow-3d-light hover:shadow-lg transition">
          <h2 className="font-head text-xl head-gradient mb-3">Why CVCraft?</h2>
          <ul className="list-disc list-inside text-paragraph space-y-1">
