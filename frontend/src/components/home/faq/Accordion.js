        ...
        <Disclosure key={index}>
          {({ open }) => (
            <div className="px-2 md:px-6 py-2 md:py-3">
              <Disclosure.Button className="flex justify-between w-full text-left text-lg md:text-xl font-medium text-gray-800 hover:bg-gray-50 px-4 py-2 md:px-6 md:py-2 rounded-lg transition">
              ...
              <SmoothPanel open={open}>
                <div className="px-4 md:px-6 pb-4 pt-2 text-gray-600 space-y-2 md:space-y-3 text-sm md:text-base">
