  ...
  sections: [
    {
      ...
      fields: [
        ...
        { name: "subSummary", label: "Mini Cover Letter / Summary", type: "textarea", isLarge: true },
      ],
    },
    {
      name: "contact",
    ...
    // --- Work Experience Section ---
    {
      ...
      fields: [
        ...
        { name: "details", label: "Languages/Skills and Tasks (Comma-separated lines)", type: "textarea", isLarge: true },
      ],
    },
    // --- Projects Section ---
    {
      ...
      fields: [
        ...
        { name: "details", label: "Details (Comma-separated lines)", type: "textarea", isLarge: true },
      ],
    },
    // --- Communication/Language Level ---
    {
      ...
      fields: [
        ...
        { name: "level", label: "Level (e.g., Fluent, C1, Basic)", type: "text" },
      ],
    },
  ],
};
