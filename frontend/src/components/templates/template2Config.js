export const template2Config = {
  ...
  sections: [
    ...
    },
    {
      ...
      type: "array",
      fields: [
        { name: "text", label: "Highlight or Bullet Point", type: "text", isLarge: true },
      ],
    },
    {
      name: "education",
      ...
      fields: [
        ...
        { name: "details", label: "Details (GPA, Coursework, etc.)", type: "text", isLarge: true },
      ],
    },
    {
      name: "experience",
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "description", label: "Project Description", type: "text", isLarge: true },
